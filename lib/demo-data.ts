...
export function buildDemoState(): DemoState {
  ...
  const liquidSales: LiquidSale[] = [
    {
      ...
      flavorId: "liq-inv-pupi",
      flavorName: "Pupi con licor",
      quantity: 1,
      unitPrice: 40000,
      total: 40000,
      paymentMethod: "cash",
      notes: "Venta del 7 de agosto",
      syncState: "synced",
    ...
    {
      id: "ls-aug7-chichonero",
      saleDate: "2026-08-07",
      variant: "base_con_licor",
      flavorId: "liq-inv-chichonero",
    ...
    {
      id: "ls-aug7-mora-azul",
      saleDate: "2026-08-07",
      variant: "base_sin_licor",
      flavorId: "liq-inv-mora-azul",
  ...
  const liquidInventoryMovements: LiquidInventoryMovement[] = [
    ...
    {
      id: "mov-prod-1",
      liquidInventoryId: "liq-inv-limonada-cerezada",
      flavorName: "Limonada cerezada",
      movementType: "production",
      quantity: 1,
      notes: "Producción almacenada el 6 de agosto",
      createdAt: "2026-08-06T10:00:00.000Z",
    },
    {
      id: "mov-prod-2",
      liquidInventoryId: "liq-inv-fresa-boom",
      flavorName: "Fresa Boom",
      movementType: "production",
      quantity: 2,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-3",
      liquidInventoryId: "liq-inv-cereza",
      flavorName: "Cereza",
      movementType: "production",
      quantity: 1,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-4",
      liquidInventoryId: "liq-inv-mora-azul",
      flavorName: "Mora azul",
      movementType: "production",
      quantity: 2,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-5",
      liquidInventoryId: "liq-inv-maracuya",
      flavorName: "Maracuyá",
      movementType: "production",
      quantity: 2,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-6",
      liquidInventoryId: "liq-inv-mango-biche",
      flavorName: "Mango biche",
      movementType: "production",
      quantity: 3,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-7",
      liquidInventoryId: "liq-inv-pina",
      flavorName: "Piña",
      movementType: "production",
      quantity: 1,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-8",
      liquidInventoryId: "liq-inv-sombra",
      flavorName: "Sombra con licor",
      movementType: "production",
      quantity: 1,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-9",
      liquidInventoryId: "liq-inv-azulito",
      flavorName: "Azulito con licor",
      movementType: "production",
      quantity: 2,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-10",
      liquidInventoryId: "liq-inv-chichonero",
      flavorName: "Chichonero con licor",
      movementType: "production",
      quantity: 2,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-11",
      liquidInventoryId: "liq-inv-zambapalo",
      flavorName: "Zambapalo con licor",
      movementType: "production",
      quantity: 1,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-12",
      liquidInventoryId: "liq-inv-pupi",
      flavorName: "Pupi con licor",
      movementType: "production",
      quantity: 2,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-13",
      liquidInventoryId: "liq-inv-ojo-diablo",
      flavorName: "Ojo de diablo con licor",
      movementType: "production",
      quantity: 1,
      notes: "Producción almacenada el 6 de agosto",
    ...
    {
      id: "mov-prod-14",
      liquidInventoryId: "liq-inv-tussy",
      flavorName: "Tussy con licor",
      movementType: "production",
      quantity: 1,
      notes: "Producción almacenada el 6 de agosto",
    ...
    // --- Ventas (7 de Agosto) ---
    {
      ...
      movementType: "sale",
      quantity: -1,
      notes: "Venta realizada el 7 de agosto",
      createdAt: "2026-08-07T18:00:00.000Z",
    },
    {
      id: "mov-sale-2",
    ...
    // --- Uso en Punto (7 de Agosto) ---
    {
      ...
      quantity: -1,
      notes: "Carga de granizadora en punto (7 de agosto)",
    ...
    // --- Uso en Punto (8 de Agosto) ---
    {
      ...
      movementType: "point_use",
      quantity: -1,
      notes: "Carga de granizadora en punto (8 de agosto)",
