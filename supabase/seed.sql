...
insert into public.product_types (id, code, label, price_modifier, cost_modifier, inventory_item_id, usage_quantity)
  ...
  ('44444444-5555-5555-5555-555555555555', 'gomitas-enchilada', 'Gomitas Enchiladas', 0, 0, null, 1)
on conflict (code) do update
set
  label = excluded.label,
...
values
  ...
  ('88888888-8888-8888-8888-888888888888', 'Enchilado / Directo', '#ff4500', true, null)
on conflict (name) do update
set
